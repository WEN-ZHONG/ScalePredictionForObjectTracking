...
for frame = 1:num_frames
    ...
    if frame == 1
        ...
        % xl is 1*1 cell 51*51*31 single value 
        ...
        xlf = compact_fourier_coeff(xlf);  % Creates a compact fourier series representation by removing the strict right half plane.
    ...
    if params.use_sample_merge
        ...
        % Do the traditional adding of a training sample and weight update of C-COT
...
%=======================SPM INTEGRATION=======================%
     ...
     w1 = w0*scale;
     target_sz = [w1 h1];
     currentScaleFactor = sqrt(prod(target_sz)/prod(base_target_sz));
%=======================SPM INTEGRATION=======================%
